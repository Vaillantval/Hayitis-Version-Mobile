...
class _$ProductDetailImpl implements _ProductDetail {
  const _$ProductDetailImpl({
    ...
    required this.price,
    @JsonKey(name: 'compare_at_price') required this.compareAtPrice,
    ...
    this.brand,
    @JsonKey(name: 'is_best_seller') required this.isBestSeller,
    @JsonKey(name: 'is_featured') required this.isFeatured,
    @JsonKey(name: 'is_new_arrival') required this.isNewArrival,
  ...
  final List<CategoryBrief> _categories;
  @override
  List<CategoryBrief> get categories {
...
abstract class _ProductDetail implements ProductDetail {
  const factory _ProductDetail({
    ...
    @JsonKey(name: 'compare_at_price') required final double compareAtPrice,
    ...
    final String? brand,
    @JsonKey(name: 'is_best_seller') required final bool isBestSeller,
    @JsonKey(name: 'is_featured') required final bool isFeatured,
    @JsonKey(name: 'is_new_arrival') required final bool isNewArrival,

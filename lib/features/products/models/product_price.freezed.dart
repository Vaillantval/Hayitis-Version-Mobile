...
class _$ProductPriceImpl implements _ProductPrice {
  ...
  @override
  String toString() {
    return 'ProductPrice(id: $id, label: $label, price: $price, regularPrice: $regularPrice, order: $order)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, label, price, regularPrice, order);
  ...
  Map<String, dynamic> toJson() {
    return _$$ProductPriceImplToJson(this);
  }
}
